# RailsAdmin config file. Generated on March 10, 2013 10:46
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Peehere', 'Admin']
  ...
  config.authorize_with do
    redirect_to new_user_session_path unless warden.user.is_admin?
  end
  ...
  # config.excluded_models = ['Comment', 'Location', 'PlacesCache', 'Rating', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Comment', 'Location', 'PlacesCache', 'Rating', 'User']
  ...
  #     configure :indoor, :boolean 
  #     configure :address, :string 
  #     configure :description, :text 
  #     configure :name, :text 
  #     configure :average, :serialized 
  #     configure :cache_id, :integer 
  ...
  # config.model 'PlacesCache' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your places_cache.rb model definition
  ...
  #     configure :cid, :string 
  #     configure :website, :string 
  #     configure :google_place_id, :text 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
